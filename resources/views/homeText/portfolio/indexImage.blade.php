                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('add-portfolio.store') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                                        @csrf
                                        <h3>ผลงาน</h3>
                                        <p>เพิ่ม ภาพ</p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('textH1NamePortfolio') is-invalid @enderror" id="val-username" name="textH1NamePortfolio" placeholder="ข้อความ H1..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('textPNamePortfolio') is-invalid @enderror" id="val-username" name="textPNamePortfolio" placeholder="ข้อความ P..">

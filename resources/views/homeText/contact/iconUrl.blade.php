                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('add-contactUrl.store') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                                        @csrf
                                        <h3>ติดต่อเรา</h3>
                                        <p>เพิ่ม ที่ติดต่อ</p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('contactUrl') is-invalid @enderror" id="val-username" name="contactUrl" placeholder="Url">
                                                @error('contactUrl')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

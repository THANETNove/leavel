                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation">
                                    @foreach ($flight as $cont)
                                        ...
                                        @else
                                        <a  type="button"   href="{{ url('imeiJob', $cont->id) }}" {{--  href="{{ route('job-system.edit', $cont->id) }}"  --}}onClick="javascript:return confirm('ยังไม่สามารถพิมพ์ใบประกันได้ กรุณาเพิ่ม IMEI ก่อน หรือ ยังทำการซ่อมไม่เสร็จ');"
                                            class="btn btn-info search-right" >ใบรับประกัน</a>
                                        @endif
                            ...
                            <div class="form-group row">
                                <div class="col-lg-7 ml-auto">
                                    <br>
                                    <a href="{{ url('job-Status') }}" class="btn btn-primary">ย้อนกลับ</a>
      ...
      <div class="modal-content">
        ...
        @endphp
            ...
            <div class="modal-body">
                ...
                <br/>
                <textarea class="form-control" id="commentBranch" rows="3"  name="commentBranch" placeholder="รายละเอียด กรณีส่งซ่อม /  อื่นๆ"></textarea>
                <br/>
                <textarea class="form-control" id="commentMend" rows="3" name="commentMend"    placeholder="รายละเอียด การซ่อม /  อื่นๆ"></textarea>
            </div>
            <div class="modal-footer">
            <button type="button" href="javascript:void(0)" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
